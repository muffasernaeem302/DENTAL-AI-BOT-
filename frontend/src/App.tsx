...
function App() {
  const skipSignIn = import.meta.env.DEV

  return (
    <Routes>
      <Route path="/" element={skipSignIn ? <Navigate to="/patient" replace /> : <HomePage />} />
      <Route path="/login" element={skipSignIn ? <Navigate to="/patient" replace /> : <LoginPage />} />
